# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak2)

- RunId: "20260524-084808"
- GeneratedAt: 2026-05-24 08:48:08
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.151856%, p95=5.903303%, min=0%, max=9.991008%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=527.313889us, p95=956.5us, min=446.1us, max=956.7us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=265.2195ms, p95=300ms, min=1.333ms, max=300ms, n=60
...
- Avg processing time (raw us): 527.313889
- P95 processing time (raw us): 956.5
