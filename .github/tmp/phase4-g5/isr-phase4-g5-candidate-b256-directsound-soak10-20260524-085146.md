# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak10)

- RunId: "20260524-085146"
- GeneratedAt: 2026-05-24 08:51:46
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.357477%, p95=6.165473%, min=0%, max=11.444299%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=514.183333us, p95=631.1us, min=444.4us, max=828.7us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.254717ms, p95=300ms, min=1.156ms, max=300ms, n=60
...
- Avg processing time (raw us): 514.183333
- P95 processing time (raw us): 631.1
