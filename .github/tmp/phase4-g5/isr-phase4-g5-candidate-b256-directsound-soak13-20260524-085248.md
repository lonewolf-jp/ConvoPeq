# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak13)

- RunId: "20260524-085248"
- GeneratedAt: 2026-05-24 08:52:48
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.027727%, p95=5.67336%, min=0%, max=9.878841%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=500.227778us, p95=644.2us, min=446us, max=650.9us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.254283ms, p95=300ms, min=1.177ms, max=300ms, n=60
...
- Avg processing time (raw us): 500.227778
- P95 processing time (raw us): 644.2
