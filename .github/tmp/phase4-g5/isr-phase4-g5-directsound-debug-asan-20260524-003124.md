# ISR Phase4 G5 Auto Measurement (directsound-debug-asan)

- RunId: "20260524-003124"
- GeneratedAt: 2026-05-24 00:31:24
- AppExitCode: -1073741515

## CPU (Process Sampling)
- CPU Usage: avg=0%, p95=0%, min=0%, max=0%, n=23
...
- Fixed-config validation failed. requested(buffer=256, sampleRateHz=44100) effective(buffer=0, sampleRateHz=0) appExitCode=-1073741515 appExitOk=False bufferMatch=False sampleRateMatch=False
