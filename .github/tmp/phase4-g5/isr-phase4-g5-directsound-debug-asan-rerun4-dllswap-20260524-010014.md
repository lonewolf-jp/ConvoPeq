# ISR Phase4 G5 Auto Measurement (directsound-debug-asan-rerun4-dllswap)

- RunId: "20260524-010014"
- GeneratedAt: 2026-05-24 01:00:14
- AppExitCode: -1

## CPU (Process Sampling)
- CPU Usage: avg=0%, p95=0%, min=0%, max=0%, n=432
...
- Fixed-config validation failed. requested(buffer=256, sampleRateHz=44100) effective(buffer=0, sampleRateHz=0) appExitCode=-1 appExitOk=False bufferMatch=False sampleRateMatch=False
