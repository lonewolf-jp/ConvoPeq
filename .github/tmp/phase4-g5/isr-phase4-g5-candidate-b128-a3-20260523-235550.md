# ISR Phase4 G5 Auto Measurement (candidate-b128-a3)

- RunId: "20260523-235550"
- GeneratedAt: 2026-05-23 23:55:50
- AppExitCode: -1073740940

## CPU (Process Sampling)
- CPU Usage: avg=2.584751%, p95=8.04618%, min=0%, max=10.016975%, n=113
...
- Requested: bufferSamples=128, sampleRateHz=192000
...
- Requested fixed audio setup was not satisfied. requested(buffer=128, sampleRateHz=192000) effective(buffer=0, sampleRateHz=0) appExitCode=-1073740940
