# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak15)

- RunId: "20260524-085330"
- GeneratedAt: 2026-05-24 08:53:30
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.424332%, p95=6.646231%, min=0%, max=11.385043%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=501.7us, p95=646.8us, min=443.4us, max=720.7us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.271017ms, p95=300ms, min=1.481ms, max=300ms, n=60
...
- Avg processing time (raw us): 501.7
- P95 processing time (raw us): 646.8
