# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak11)

- RunId: "20260524-085206"
- GeneratedAt: 2026-05-24 08:52:06
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.296276%, p95=5.730732%, min=0%, max=12.35265%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=507.747222us, p95=628.4us, min=443.3us, max=755.1us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.280083ms, p95=300ms, min=1.132ms, max=300ms, n=60
...
- Avg processing time (raw us): 507.747222
- P95 processing time (raw us): 628.4
