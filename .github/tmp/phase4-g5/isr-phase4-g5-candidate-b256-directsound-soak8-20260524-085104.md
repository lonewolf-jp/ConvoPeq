# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak8)

- RunId: "20260524-085104"
- GeneratedAt: 2026-05-24 08:51:04
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.32342%, p95=6.162145%, min=0%, max=11.33451%, n=93

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=532.261111us, p95=736.9us, min=457.8us, max=922.2us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.2489ms, p95=300ms, min=1.107ms, max=300ms, n=60
...
- Avg processing time (raw us): 532.261111
- P95 processing time (raw us): 736.9
