# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak14)

- RunId: "20260524-085309"
- GeneratedAt: 2026-05-24 08:53:09
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.260978%, p95=5.375815%, min=0.45902%, max=9.437164%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=500.847222us, p95=610.9us, min=443.1us, max=663us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=265.24935ms, p95=300ms, min=1.291ms, max=300ms, n=60
...
- Avg processing time (raw us): 500.847222
- P95 processing time (raw us): 610.9
