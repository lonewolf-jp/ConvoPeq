# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak7)

- RunId: "20260524-085043"
- GeneratedAt: 2026-05-24 08:50:43
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.067339%, p95=5.711084%, min=0%, max=8.349388%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=530.758333us, p95=721.8us, min=443.1us, max=1338us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.284917ms, p95=300ms, min=1.137ms, max=300ms, n=60
...
- Avg processing time (raw us): 530.758333
- P95 processing time (raw us): 721.8
