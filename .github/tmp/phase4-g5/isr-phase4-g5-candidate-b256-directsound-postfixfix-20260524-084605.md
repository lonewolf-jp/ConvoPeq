# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-postfixfix)

- RunId: "20260524-084605"
- GeneratedAt: 2026-05-24 08:46:05
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.14438%, p95=5.715326%, min=0%, max=9.480062%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=517.911429us, p95=688.1us, min=444us, max=1161.9us, n=35

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=265.228033ms, p95=300ms, min=1.238ms, max=300ms, n=60
...
- Avg processing time (raw us): 517.911429
- P95 processing time (raw us): 688.1
