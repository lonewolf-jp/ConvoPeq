# ISR Phase4 G5 Auto Measurement (baseline-b256-logprobe2)

- RunId: "20260524-000940"
- GeneratedAt: 2026-05-24 00:09:40
- AppExitCode: -1073740940

## CPU (Process Sampling)
- CPU Usage: avg=3.361493%, p95=8.563688%, min=0%, max=9.981564%, n=31

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=1407.35us, p95=2038.5us, min=776.2us, max=2038.5us, n=2

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=269.723339ms, p95=300ms, min=1.57ms, max=300ms, n=59
...
- Avg processing time (raw us): 1407.35
- P95 processing time (raw us): 2038.5
