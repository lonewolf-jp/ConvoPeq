# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-postfix-r2)

- RunId: "20260524-082307"
- GeneratedAt: 2026-05-24 08:23:07
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.031974%, p95=5.703956%, min=0%, max=9.468177%, n=92
...
- Fixed-config validation failed. requested(buffer=256, sampleRateHz=44100) effective(buffer=0, sampleRateHz=0) appExitCode=0 appExitOk=True bufferMatch=False sampleRateMatch=False
