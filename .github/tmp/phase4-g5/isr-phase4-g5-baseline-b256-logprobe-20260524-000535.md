# ISR Phase4 G5 Auto Measurement (baseline-b256-logprobe)

- RunId: "20260524-000535"
- GeneratedAt: 2026-05-24 00:05:35
- AppExitCode: -1073740940

## CPU (Process Sampling)
- CPU Usage: avg=3.016657%, p95=9.522771%, min=0%, max=9.952833%, n=32

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=2159.5us, p95=2159.5us, min=2159.5us, max=2159.5us, n=1

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=270.211233ms, p95=300ms, min=1.396ms, max=300ms, n=60
...
- same_as_pending_would_merge: 109
- pending_duplicate: 0
...
- Avg processing time (raw us): 2159.5
- P95 processing time (raw us): 2159.5
