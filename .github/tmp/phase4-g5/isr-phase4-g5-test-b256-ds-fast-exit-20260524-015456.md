# ISR Phase4 G5 Auto Measurement (test-b256-ds-fast-exit)

- RunId: "20260524-015456"
- GeneratedAt: 2026-05-24 01:54:56
- AppExitCode: -1073740940

## CPU (Process Sampling)
- CPU Usage: avg=2.198032%, p95=7.612764%, min=0%, max=9.986114%, n=32
...
- Fixed-config validation failed. requested(buffer=256, sampleRateHz=44100) effective(buffer=0, sampleRateHz=0) appExitCode=-1073740940 appExitOk=False bufferMatch=False sampleRateMatch=False
