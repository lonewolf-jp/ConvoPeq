# ISR Phase4 G5 Auto Measurement (candidate-b256-directsound-soak5)

- RunId: "20260524-084910"
- GeneratedAt: 2026-05-24 08:49:10
- AppExitCode: 0

## CPU (Process Sampling)
- CPU Usage: avg=2.624532%, p95=5.701223%, min=0%, max=10.390797%, n=92

## Processing Time Raw (CLI_PERF_RAW)
- Process Time: avg=501.627778us, p95=567.2us, min=444.1us, max=648us, n=36

## Rebuild Latency (from log latencyMs=...)
- Rebuild Latency: avg=260.28485ms, p95=300ms, min=1.184ms, max=300ms, n=60
...
- Avg processing time (raw us): 501.627778
- P95 processing time (raw us): 567.2
