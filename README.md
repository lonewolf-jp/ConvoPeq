...
- **Psychoacoustic Dither**: POW-r Type 1 近似アルゴリズム + **Xoshiro256\*\*** PRNG による高精度ノイズシェーピング・ディザリング (Bit Depth選択可能)
...
本ソフトウェアは開発初期段階（v0.2）のプロトタイプであり、以下の理由からライブパフォーマンスや業務用途などのクリティカルな本番環境での使用は推奨されません。
